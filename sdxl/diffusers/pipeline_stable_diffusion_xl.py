...
class StableDiffusionXLPipeline(
        ...
        **kwargs,
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                idx = t_to_idx[int(t)]
                latents = self.scheduler.step(noise_pred, t, latents, variance_noise=self.zs[idx], **extra_step_kwargs, return_dict=False)[0]
    ...
    def invert(
        ...
        negative_prompt_embeds, prompt_embeds = prompt_embeds, negative_prompt_embeds
        negative_pooled_prompt_embeds, edit_pooled_prompt_embeds = pooled_prompt_embeds, negative_pooled_prompt_embeds
